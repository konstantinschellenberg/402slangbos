...
def main():
    ...
    shp = 'F:/geodata/geo402/S2/xx_S2_indices/##study_area/LADYBRAND_final_enlarged_study_area.shp'
    ...
    dir_in = 'F:/geodata/geo402/S1_SLC/xx_new/SLCs/'
    print(dir_in)
    # os.makedirs(dir_in, exist_ok=True)

    # define output file name
    dstfile = 'F:/geodata/geo402/S1_SLC/xx_new/S1A__IW___A__coherence_stack.vrt'
    print(dstfile)

    # list files to be resampled; those not overlapping with the shapefile geometry will excluded by function stack
    srcfiles = finder(dir_in, ['*tif'])
...
with open('F:/geodata/geo402/S1_SLC/xx_new/inputfiles.txt', 'w') as filehandle:
